...
async def get_thumb(videoid, user_id):
    ...
    try:
        ...
        try:
            title_font = ImageFont.truetype("AviaxMusic/assets/font3.ttf", 32)
            regular_font = ImageFont.truetype("AviaxMusic/assets/font4.ttf", 18)
        except OSError:
        ...
        font = ImageFont.truetype("AviaxMusic/assets/font3.ttf", 28)  
        text = " "
