...
API_KEY = getenv("API_KEY", "NxGBNexGenBots308a64") # youtube song api key, generate free key or buy paid plan from https://console.nexgenbots.xyz

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ixbittu/Tq",
)
